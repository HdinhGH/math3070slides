...
\begin{frame}{Example, Difference of Random Variables}
    ...
    \uncover<3->{$L = \frac{1}{2}Y-X$ normally distributed. Just need the mean and standard deviation. There is leftover chemical Y when $L>0$.}
    \uncover<4->{$$E[L] = \frac{1}{2}E[Y] - E[X] = \frac{1}{2}300 - 150 = 0 $$}
    \uncover<5->{$$ Var(L) = \bigg(\frac{1}{2}\bigg)^2Var(Y) + (-1)^2Var(X) = 1+ 1=2 $$}
\end{frame}
\begin{frame}{Example, Difference of Random Variables}
    $$L\sim N(0,2)$$
